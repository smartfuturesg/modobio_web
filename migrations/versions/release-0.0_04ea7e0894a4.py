...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["facility_id"], ["RegisteredFacilities.facility_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["User.user_id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("idx"),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["MedicalConditions.medical_condition_id"],
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(["user_id"], ["User.user_id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("idx"),
    ...
    op.create_table(
        ...
        sa.Column(
            "toe_touch_pelvis_movement",
            sa.ARRAY(sa.String()),
            server_default="{'Even Bilaterally'}",
            nullable=True,
        ),
        sa.Column(
            "toe_touch_ribcage_movement",
            sa.ARRAY(sa.String()),
            server_default="{'Even Bilaterally'}",
            nullable=True,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "timestamps", postgresql.ARRAY(sa.DateTime(), dimensions=1), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["release_contract_id"], ["ClientRelease.idx"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["User.user_id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("idx"),
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["result_id"], ["MedicalBloodTestResultTypes.result_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["test_id"], ["MedicalBloodTests.test_id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("idx"),
    )
