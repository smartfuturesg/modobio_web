...
def test_get_2_specific_client_appointment_queue(test_client, init_database, client_auth_header, staff_auth_header):
    ...
    for header in (staff_auth_header, ):
        ...
        assert [response.json['availability'][3]['day_of_week'], response.json['availability'][3]['start_time'], response.json['availability'][3]['end_time']] == ['Thursday', '09:00:00', '20:00:00'] 
...
def test_get_3_specific_client_appointment_queue(test_client, init_database, client_auth_header, staff_auth_header):
    """
    GIVEN a api end point for staff general availability
    WHEN the '/telehealth/settings/staff/availability/<user_id>/' resource  is requested (GET)
    THEN check the response is valid
...
def test_get_4_specific_client_appointment_queue(test_client, init_database, client_auth_header, staff_auth_header):
    """
    GIVEN a api end point for staff general availability
    WHEN the '/telehealth/settings/staff/availability/<user_id>/' resource  is requested (GET)
    THEN check the response is valid
...
def test_get_5_specific_client_appointment_queue(test_client, init_database, client_auth_header, staff_auth_header):
    """
    GIVEN a api end point for staff general availability
    WHEN the '/telehealth/settings/staff/availability/<user_id>/' resource  is requested (GET)
    THEN check the response is valid
...
def test_get_6_specific_client_appointment_queue(test_client, init_database, client_auth_header, staff_auth_header):
    """
    GIVEN a api end point for staff general availability
    WHEN the '/telehealth/settings/staff/availability/<user_id>/' resource  is requested (GET)
    THEN check the response is valid
...
def test_get_7_specific_client_appointment_queue(test_client, init_database, client_auth_header, staff_auth_header):
    """
    GIVEN a api end point for staff general availability
    WHEN the '/telehealth/settings/staff/availability/<user_id>/' resource  is requested (GET)
    THEN check the response is valid
