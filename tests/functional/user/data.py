...
# For readability
# 1/5/2025
users_queue_client_pool_1_post_data = {
  'profession_type': 'Medical Doctor',
  'target_date': '2025-01-05T02:00:00.000',
  'priority': False
}
# 3/5/2025
users_queue_client_pool_2_post_data = {
  'profession_type': 'Medical Doctor',
  'target_date': '2025-03-05T02:00:00.000',
  'priority': False
}
# 2/5/2025
users_queue_client_pool_3_post_data = {
  'profession_type': 'Medical Doctor',
  'target_date': '2025-02-05T02:00:00.000',
  'priority': False
}
# 1/2/2025
users_queue_client_pool_4_post_data = {
  'profession_type': 'Medical Doctor',
  'target_date': '2025-01-02T02:00:00.000',
  'priority': False
}
# 4/5/2025
users_queue_client_pool_5_post_data = {
  'profession_type': 'Medical Doctor',
  'target_date': '2025-04-05T02:00:00.000',
  'priority': False
}
# 2/7/2025
users_queue_client_pool_6_post_data = {
  'profession_type': 'Medical Doctor',
  'target_date': '2025-02-07T02:00:00.000',
  'priority': True
}
# 2/5/2025
users_queue_client_pool_1_put_data = {
  'profession_type': 'Medical Doctor',
  'target_date': '2025-02-05T02:00:00.000',
  'priority': True
}