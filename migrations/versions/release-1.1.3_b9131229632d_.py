...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "exception_booking_window_id_start_time", sa.Integer(), nullable=False
        ),
    ...
    op.add_column(
        "MedicalBloodTests", sa.Column("image_path", sa.String(), nullable=True)
    )
    op.add_column(
        "Notifications", sa.Column("persona_type", sa.String(length=10), nullable=True)
    )
    op.drop_column("Notifications", "time_to_live")
    op.add_column(
        "PaymentHistory",
        sa.Column("transaction_descriptor", sa.String(), nullable=True),
    )
    op.add_column(
        "PaymentHistory", sa.Column("authorization_number", sa.String(), nullable=True)
    )
    op.drop_constraint(
    ...
    op.add_column(
        "TelehealthBookingDetails", sa.Column("reason_id", sa.Integer(), nullable=True)
    )
    op.create_foreign_key(
        None, "TelehealthBookingDetails", "LookupVisitReasons", ["reason_id"], ["idx"]
    )
    op.add_column(
        "TelehealthBookings", sa.Column("notified", sa.Boolean(), nullable=True)
    )
    op.add_column(
        "TelehealthBookings",
    ...
    op.add_column(
        "TelehealthBookings",
        sa.Column("scheduled_duration_mins", sa.Integer(), nullable=True),
    )
    op.add_column(
        "TelehealthBookings", sa.Column("payment_notified", sa.Boolean(), nullable=True)
    )
    op.create_foreign_key(
        None, "TelehealthBookings", "PaymentHistory", ["payment_history_id"], ["idx"]
    )
    op.add_column(
        "UserLogin",
        sa.Column("staff_account_closed_reason", sa.String(length=500), nullable=True),
    )
    op.add_column(
        "UserLogin",
        sa.Column("client_account_closed_reason", sa.String(length=500), nullable=True),
    )
    op.add_column(
...
def downgrade():
    ...
    op.add_column(
        "Notifications",
        sa.Column("time_to_live", sa.INTEGER(), autoincrement=False, nullable=True),
    )
    ...
    op.add_column(
        "LookupNotifications",
        sa.Column("symbol_color", sa.VARCHAR(), autoincrement=False, nullable=True),
    )
