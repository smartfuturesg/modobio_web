...
def upgrade():
    ...
    op.add_column('LookupCurrencies', sa.Column('max_rate', sa.Numeric(precision=10, scale=2), nullable=True))
    op.add_column('LookupCurrencies', sa.Column('min_rate', sa.Numeric(precision=10, scale=2), nullable=True))
