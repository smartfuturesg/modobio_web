...
def test_oura_pre_auth(test_client, init_database, client_auth_header):
    """
...
def test_oura_auth_get(test_client, init_database, client_auth_header):
    """
    GIVEN an API end point for Oura Ring OAuth authentication
    WHEN the '/wearables/oura/auth/<user_id>' resource is requested (GET)
    THEN check the response is valid
    """

    response = test_client.get(
        '/wearables/oura/auth/1/',
        headers=client_auth_header
    )
...
@pytest.mark.skip('AWS Parameter Store not available during testing.')
def test_oura_auth_post(test_client, init_database, client_auth_header):
    """
    GIVEN an API end point for Oura Ring OAuth authentication
    WHEN the '/wearables/oura/auth/<user_id>' resource is requested (POST)
    THEN check the response is valid
    """
...
def test_oura_auth_delete(test_client, init_database, client_auth_header):
    """
    GIVEN an API end point for Oura Ring OAuth authentication
    WHEN the '/wearables/oura/auth/<user_id>' resource is requested (DELETE)
    THEN check the response is valid
    """
