...
def upgrade():
    ...
    op.add_column(
        ...
        sa.Column(
            "availability_horizon", sa.Integer(), server_default="2", nullable=False
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "medical_condition_id", sa.Integer(), autoincrement=True, nullable=False
        ),
        sa.Column("category", sa.String(), nullable=True),
    ...
    op.drop_constraint(
        "MedicalFamilyHistory_medical_condition_id_fkey",
    ...
    op.drop_constraint(
        "MedicalSTDHistory_std_id_fkey", "MedicalSTDHistory", type_="foreignkey"
    )
    op.create_foreign_key(
        None,
        "MedicalSTDHistory",
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            server_default=sa.text(
                "nextval('\"LookupTransactionTypes_idx_seq\"'::regclass)"
            ),
            autoincrement=True,
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.INTEGER(),
            server_default=sa.text(
                "nextval('\"ClientTransactionHistory_idx_seq\"'::regclass)"
            ),
            autoincrement=True,
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["User.user_id"],
            name="ClientTransactionHistory_user_id_fkey",
            ondelete="CASCADE",
        ),
    ...
    op.add_column(
        ...
        sa.Column("drinks", sa.BOOLEAN(), autoincrement=False, nullable=True),
    )
    op.create_table(
        ...
        sa.Column(
            ...
            sa.INTEGER(),
            server_default=sa.text(
                "nextval('\"ClientAssignedDrinks_idx_seq\"'::regclass)"
            ),
            autoincrement=True,
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ...
            name="ClientAssignedDrinks_drink_id_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["User.user_id"],
            name="ClientAssignedDrinks_user_id_fkey",
            ondelete="CASCADE",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.INTEGER(),
            server_default=sa.text(
                "nextval('\"LookupDrinks_drink_id_seq\"'::regclass)"
            ),
            autoincrement=True,
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["primary_goal_id"],
            ["LookupGoals.goal_id"],
            name="LookupDrinks_primary_goal_id_fkey",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.INTEGER(),
            server_default=sa.text(
                "nextval('\"LookupDrinkIngredients_idx_seq\"'::regclass)"
            ),
            autoincrement=True,
            nullable=False,
        ),
        sa.Column("drink_id", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column(
            "is_primary_ingredient", sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["drink_id"],
            ["LookupDrinks.drink_id"],
            name="LookupDrinkIngredients_drink_id_fkey",
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.INTEGER(),
            server_default=sa.text(
                "nextval('\"MedicalLookUpSTD_std_id_seq\"'::regclass)"
            ),
            autoincrement=True,
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.INTEGER(),
            server_default=sa.text(
                "nextval('\"MedicalLookUpBloodPressureRange_idx_seq\"'::regclass)"
            ),
            autoincrement=True,
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.INTEGER(),
            server_default=sa.text(
                "nextval('\"MedicalConditions_medical_condition_id_seq\"'::regclass)"
            ),
            autoincrement=True,
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.INTEGER(),
            server_default=sa.text(
                "nextval('\"MedicalBloodTestResultTypes_result_id_seq\"'::regclass)"
            ),
            autoincrement=True,
            nullable=False,
        ),
