...
def upgrade():
    ...
    op.add_column('LookupCurrencies', sa.Column('max_rate', sa.Integer(), nullable=True))
    op.add_column('LookupCurrencies', sa.Column('min_rate', sa.Integer(), nullable=True))
    op.add_column('StaffRoles', sa.Column('consult_rate', sa.Numeric(), nullable=True))
    op.add_column('TelehealthBookings', sa.Column('consult_rate', sa.Numeric(), nullable=True))
