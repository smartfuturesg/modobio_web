...
def test_post_chessboard_assessment(test_client):
    ...
    assert (
        response.json["isa_structure"]
        == trainer_chessboard_assessment_data["isa_structure"]
    )
    assert (
        response.json["hip"]["left"]["flexion"]
        == trainer_chessboard_assessment_data["hip"]["left"]["flexion"]
    )
