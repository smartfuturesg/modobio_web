...
Revision ID: 07c8cc28ad4a
Revises: c629447e4622
Create Date: 2020-10-20 11:21:19.633459
...
def upgrade():
    ...
    op.add_column('MedicalBloodTestResultTypes', sa.Column('result_id', sa.Integer(), autoincrement=True, nullable=False))
    op.drop_column('MedicalBloodTestResultTypes', 'resultid')
    op.create_primary_key('MedicalBloodTestResultTypes_pkey', 'MedicalBloodTestResultTypes', ['result_id'])
    ...
    op.add_column('MedicalBloodTests', sa.Column('test_id', sa.Integer(), autoincrement=True, nullable=False))
    ...
    op.drop_column('MedicalBloodTests', 'testid')
    op.create_primary_key('MedicalBloodTests_pkey', 'MedicalBloodTests', ['test_id'])
