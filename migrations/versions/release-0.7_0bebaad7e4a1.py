...
def upgrade():
    ...
    op.add_column(
        "StaffProfile", sa.Column("profile_picture", sa.String(), nullable=True)
    )
    op.create_table(
        "LookupRoles",
        sa.Column("idx", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["race_id"], ["LookupRaces.race_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["User.user_id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("idx"),
    )
    ...
    op.add_column(
        "ClientClinicalCareTeam", sa.Column("is_temporary", sa.Boolean(), nullable=True)
    )
    op.create_table(
        "LookupMacroGoals",
        sa.Column(
    ...
    op.add_column(
        "ClientInfo", sa.Column("primary_macro_goal_id", sa.Integer(), nullable=True)
    )
    op.add_column(
        "ClientInfo",
        sa.Column("primary_goal_description", sa.String(length=300), nullable=True),
    )
    op.create_foreign_key(
        None, "ClientInfo", "LookupMacroGoals", ["primary_macro_goal_id"], ["goal_id"]
    )
    op.add_column(
        "NotificationsPushRegistration",
        sa.Column("device_voip_token", sa.String(length=1024), nullable=True),
    )
    op.add_column(
        "NotificationsPushRegistration",
        sa.Column("voip_arn", sa.String(length=256), nullable=True),
    )
    op.add_column(
        "MedicalBloodPressures", sa.Column("reporter_id", sa.Integer(), nullable=False)
    )
    op.create_foreign_key(
        None, "MedicalBloodPressures", "User", ["reporter_id"], ["user_id"]
    )
    op.create_table(
        "LookupLegalDocs",
        sa.Column("idx", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["doc_id"], ["LookupLegalDocs.idx"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["User.user_id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("idx"),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["client_id"], ["ClientInfo.user_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["staff_id"], ["StaffProfile.user_id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("idx"),
    )
    op.create_table(
    ...
    op.add_column(
        "TelehealthBookings", sa.Column("client_timezone", sa.String(), nullable=True)
    )
    op.add_column(
        "TelehealthBookings", sa.Column("staff_timezone", sa.String(), nullable=True)
    )
    op.add_column(
        "TelehealthBookings", sa.Column("target_date_utc", sa.Date(), nullable=True)
    )
    op.add_column(
        "TelehealthBookings",
        sa.Column("booking_window_id_start_time_utc", sa.Integer(), nullable=False),
    )
    op.add_column(
        "TelehealthBookings",
        sa.Column("booking_window_id_end_time_utc", sa.Integer(), nullable=False),
    )
    op.create_foreign_key(
        "lookup_booking_time_inc_utc_end_fk",
        "TelehealthBookings",
    ...
    op.create_foreign_key(
        "lookup_booking_time_inc_utc_start_fk",
        "TelehealthBookings",
        "LookupBookingTimeIncrements",
    ...
    op.create_unique_constraint(
        "telehealth_costs_unique_resource_currency_id_profession",
        "SystemTelehealthSessionCosts",
        ["currency_id", "profession_type"],
    )
    op.create_foreign_key(
        None,
        "SystemTelehealthSessionCosts",
    ...
    op.drop_constraint(
        "TelehealthStaffAvailability_user_id_fkey",
    ...
    op.add_column(
        "TelehealthBookings",
        sa.Column("client_location_id", sa.Integer(), nullable=False),
    )
    op.add_column(
        "TelehealthBookings",
    ...
    op.create_foreign_key(
        None, "TelehealthBookings", "PaymentMethods", ["payment_method_id"], ["idx"]
    )
    op.create_foreign_key(
        None,
        "TelehealthBookings",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["organization_idx"],
            ["LookupOrganizations.idx"],
        ),
        sa.ForeignKeyConstraint(["user_id"], ["User.user_id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("idx"),
    )
    op.create_foreign_key(
        None, "MedicalBloodTests", "User", ["reporter_id"], ["user_id"]
    )
    op.add_column(
        "MedicalConditions",
        sa.Column(
    ...
    op.create_foreign_key(
        None, "MedicalGeneralInfoMedications", "User", ["reporter_id"], ["user_id"]
    )
    ...
    op.create_foreign_key(
        None, "MedicalPhysicalExam", "User", ["reporter_id"], ["user_id"]
    )
    op.add_column(
        "MedicalSurgeries", sa.Column("reporter_id", sa.Integer(), nullable=False)
    )
    op.drop_constraint(
        "MedicalSurgeries_reporter_user_id_fkey", "MedicalSurgeries", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "MedicalSurgeries", "User", ["reporter_id"], ["user_id"]
    )
    op.drop_column("MedicalSurgeries", "reporter_user_id")
    op.drop_column("ClientClinicalCareTeam", "team_member_email")
    op.create_unique_constraint(
        None, "ClientClinicalCareTeam", ["user_id", "team_member_user_id"]
    )
    op.add_column(
    ...
    op.create_table(
        ...
        sa.Column(
            "transaction_amount", sa.Numeric(precision=10, scale=2), nullable=False
        ),
        sa.Column("user_id", sa.Integer(), nullable=False),
        sa.ForeignKeyConstraint(
            ["payment_method_id"], ["PaymentMethods.idx"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["User.user_id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("idx"),
    )
    ...
    op.create_foreign_key(
        None, "ClientInfo", "LookupTerritoriesOfOperations", ["territory_id"], ["idx"]
    )
    op.drop_column("ClientInfo", "state")
    op.drop_column("ClientInfo", "country")
    op.drop_constraint(
        "StaffOffices_country_id_fkey", "StaffOffices", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "StaffOffices", "LookupTerritoriesOfOperations", ["territory_id"], ["idx"]
    )
    op.drop_column("StaffOffices", "state")
    op.drop_column("StaffOffices", "country_id")
    op.drop_constraint(
        "StaffOperationalTerritories_operational_territory_id_fkey",
    ...
    op.drop_constraint(
        "TelehealthBookings_client_location_id_fkey",
        "TelehealthBookings",
        type_="foreignkey",
    )
    op.create_foreign_key(
    ...
    op.drop_constraint(
        "TelehealthQueueClientPool_location_id_fkey",
        "TelehealthQueueClientPool",
        type_="foreignkey",
    )
    op.create_foreign_key(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["booking_id"], ["TelehealthBookings.idx"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["reporter_id"],
            ["User.user_id"],
    ...
    op.alter_column(
        "TelehealthBookings", "target_date", existing_type=sa.DATE(), nullable=False
    )
    op.add_column(
        "PractitionerOrganizationAffiliation",
        sa.Column("affiliate_user_id", sa.String(), nullable=True),
    )
    op.alter_column(
        "User",
        "email",
    ...
    op.add_column(
        "TelehealthBookings", sa.Column("is_paid", sa.Boolean(), nullable=True)
    )
    op.drop_column("ClientInfo", "dob")
    op.add_column("User", sa.Column("dob", sa.Date(), nullable=True))
    op.add_column(
        "TelehealthBookings",
        sa.Column("external_booking_id", sa.String(length=36), nullable=True),
    )
    op.create_table(
        "DoseSpotProxyID",
        sa.Column(
...
def downgrade():
    ...
    op.add_column(
        "ClientInfo", sa.Column("dob", sa.DATE(), autoincrement=False, nullable=True)
    )
    ...
    op.alter_column(
        "TelehealthBookings", "target_date", existing_type=sa.DATE(), nullable=True
    )
    ...
    op.add_column(
        "StaffOffices",
        sa.Column("state", sa.VARCHAR(length=35), autoincrement=False, nullable=True),
    )
    op.drop_constraint(None, "StaffOffices", type_="foreignkey")
    op.create_foreign_key(
        "StaffOffices_country_id_fkey",
        "StaffOffices",
        "LookupCountriesOfOperations",
        ["country_id"],
        ["idx"],
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            server_default=sa.text(
                "nextval('\"LookupTerritoriesofOperation_idx_seq\"'::regclass)"
            ),
            autoincrement=True,
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["country_id"],
            ["LookupCountriesOfOperations.idx"],
            name="LookupTerritoriesofOperation_country_id_fkey",
        ),
    ...
    op.add_column(
        ...
        sa.Column(
            "team_member_email", sa.VARCHAR(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "MedicalSurgeries",
        sa.Column(
            "reporter_user_id", sa.INTEGER(), autoincrement=False, nullable=False
        ),
    )
    op.drop_constraint(None, "MedicalSurgeries", type_="foreignkey")
    op.create_foreign_key(
        "MedicalSurgeries_reporter_user_id_fkey",
        "MedicalSurgeries",
        "User",
        ["reporter_user_id"],
        ["user_id"],
    ...
    op.drop_constraint(
        "lookup_booking_time_inc_utc_end_fk", "TelehealthBookings", type_="foreignkey"
    )
    op.drop_constraint(
        "lookup_booking_time_inc_utc_start_fk", "TelehealthBookings", type_="foreignkey"
    )
    ...
    op.add_column(
        ...
        sa.Column(
            "idx",
            sa.INTEGER(),
            server_default=sa.text("nextval('\"StaffProfile_idx_seq\"'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
    )
    op.add_column(
        ...
        sa.Column(
            "idx",
            sa.INTEGER(),
            server_default=sa.text("nextval('\"ClientInfo_idx_seq\"'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
    )
    ...
    op.create_foreign_key(
        "ClientInfo_race_id_fkey", "ClientInfo", "LookupRaces", ["race_id"], ["race_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.INTEGER(),
            server_default=sa.text(
                "nextval('\"LookupProfessionColors_idx_seq\"'::regclass)"
            ),
            autoincrement=True,
            nullable=False,
        ),
