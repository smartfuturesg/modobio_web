...
class EndpointARN:
    ...
    kind: str=''
    """ The kind part of SNS endpoint, either "app" for Platform Application, or "endpoint" for an Endpoint.
    ...
    channel: str=''
    """ The channel part of the ARN, the short code of the push notification operator for this channel,
    e.g. "APNS".
    ...
    label: str=''
    """ The label part of the ARN, the name given to the channel when creating the Platform Application.
    ...
    uuid: str=''
    """ The uuid part of the ARN, the endpoint uuid generated by AWS when the device endpoint was created.
