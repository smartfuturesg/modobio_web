...
def test_get_fitness_questionnaire(test_client):
    ...
    assert (
        response.json["sleep_hours"]
        == trainer_fitness_questionnaire_data["sleep_hours"]
    )
    assert (
        response.json["stress_sources"][0]
        == trainer_fitness_questionnaire_data["stress_sources"][0]
    )
