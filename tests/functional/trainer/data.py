...
trainer_movement_assessment_data = {
    "toe_touch": {
        "ribcage_movement": ["Even Bilaterally"],
        "notes": "string",
        "pelvis_movement": ["Right Hip High", "Left Hip High"],
        "depth": "string",
    },
    "squat": {
        "eye_test": True,
    ...
    "standing_rotation": {"left": {"notes": "string"}, "right": {"notes": "string"}},
}
...
trainer_chessboard_assessment_data = {
    ...
    "shoulder": {
        "left": {"er": 0, "add": 0, "flexion": 0, "ir": 0, "extension": 0, "abd": 0},
        "right": {"er": 0, "add": 0, "flexion": 0, "ir": 0, "extension": 0, "abd": 0},
    },
}
...
trainer_moxy_rip_data = {
    ...
    "performance": {
        "two": {"smo2": 0, "avg_power": 0, "thb": 10, "hr_max_min": 180},
        "one": {"smo2": 0, "avg_power": 0, "thb": 10, "hr_max_min": 140},
        "three": {"smo2": 0, "avg_power": 0, "thb": 10, "hr_max_min": 150},
        "four": {"smo2": 0, "avg_power": 0, "thb": 10, "hr_max_min": 120},
    },
    "recovery": {
        "two": {"smo2": 60, "avg_power": 60, "thb": 10, "hr_max_min": 60},
        "one": {"smo2": 20, "avg_power": 100, "thb": 10, "hr_max_min": 70},
        "three": {"smo2": 50, "avg_power": 90, "thb": 10, "hr_max_min": 70},
        "four": {"smo2": 50, "avg_power": 80, "thb": 10, "hr_max_min": 70},
    },
...
trainer_fitness_questionnaire_data = {
    ...
    "libido_level": 2,
    "stress_level": 4,
    "stress_sources": ["Family", "Finances", "Social Obligations"],
    "trainer_expectations": ["Expertise"],
    "current_fitness_level": 6,
    "lifestyle_goals": ["Increased Energy"],
    "physical_goals": ["Weight Loss", "Increase Strength"],
