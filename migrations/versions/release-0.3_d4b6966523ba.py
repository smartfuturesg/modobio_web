...
def upgrade():
    ...
    op.create_unique_constraint(
        "care_team_auth_unique_resource_user_team_member_ids",
        "ClientClinicalCareTeamAuthorizations",
    ...
    op.add_column(
        "Wearables", sa.Column("registered_fitbit", sa.Boolean(), nullable=True)
    )
    op.alter_column(
        "Wearables", "has_fitbit", existing_type=sa.BOOLEAN(), nullable=False
    )
    op.alter_column(
        "Wearables", "registered_fitbit", existing_type=sa.BOOLEAN(), nullable=False
    )
    op.alter_column(
        "WearablesFitbit",
        "access_token",
    ...
    op.add_column(
        "Wearables",
        sa.Column("has_applewatch", sa.Boolean(), server_default="f", nullable=True),
    )
    op.add_column(
        "Wearables",
        sa.Column(
            "registered_applewatch", sa.Boolean(), server_default="f", nullable=True
        ),
    )
    op.alter_column(
        "Wearables", "has_applewatch", existing_type=sa.BOOLEAN(), nullable=False
    )
    op.alter_column(
        "Wearables", "registered_applewatch", existing_type=sa.BOOLEAN(), nullable=False
    )
    op.alter_column(
        "Wearables", "has_oura", existing_type=sa.BOOLEAN(), server_default="f"
    )
    op.alter_column(
        "Wearables", "registered_oura", existing_type=sa.BOOLEAN(), server_default="f"
    )
    op.alter_column(
        "Wearables", "has_fitbit", existing_type=sa.BOOLEAN(), server_default="f"
    )
    op.alter_column(
        "Wearables", "registered_fitbit", existing_type=sa.BOOLEAN(), server_default="f"
    )
    op.alter_column(
        "Wearables", "has_freestyle", existing_type=sa.BOOLEAN(), server_default="f"
    )
...
def downgrade():
    ...
    op.alter_column(
        "Wearables", "has_oura", existing_type=sa.BOOLEAN(), server_default=None
    )
    op.alter_column(
        "Wearables", "registered_oura", existing_type=sa.BOOLEAN(), server_default=None
    )
    op.alter_column(
        "Wearables", "has_fitbit", existing_type=sa.BOOLEAN(), server_default=None
    )
    op.alter_column(
        "Wearables",
        "registered_fitbit",
    ...
    op.alter_column(
        "Wearables", "has_freestyle", existing_type=sa.BOOLEAN(), server_default=None
    )
    op.alter_column(
        "WearablesFitbit",
        "access_token",
