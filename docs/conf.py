...
exclude_patterns = [
    ...
    "odyssey/odyssey.api.dosespot.rst",
    ...
    "odyssey/odyssey.api.payment.rst",
    "odyssey/odyssey.api.physiotherapy.rst",
    "odyssey/odyssey.api.practitioner.rst",
...
autodoc_default_options = {"no-undoc-members": True, "member-order": "bysource"}
