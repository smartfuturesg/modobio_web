...
def test_post_staff_office(test_client, init_database, staff_auth_header):
    ...
    response = test_client.post('/staff/office/2/',
                                headers=staff_auth_header,
                                data=staff_office_data['invalid_country_id'])
    ...
    response = test_client.post('/staff/office/2/',
                                headers=staff_auth_header,
                                data=staff_office_data['too_long'])
    ...
    response = test_client.post('/staff/office/2/',
                                headers=staff_auth_header,
                                data=staff_office_data['invalid_phone_type'])
    ...
    response = test_client.post('/staff/office/2/',
                                headers=staff_auth_header,
                                data=staff_office_data['normal_data'])
...
def test_get_staff_office(test_client, init_database, staff_auth_header):
    ...
    response = test_client.get('/staff/office/2/',
                                headers=staff_auth_header)
...
def test_put_staff_profile(test_client, init_database, staff_auth_header):
    ...
    #test with invalid country id, should return 404
    response = test_client.put('/staff/office/2/',
                                headers=staff_auth_header,
                                data=staff_office_data['invalid_country_id'])
    ...
    response = test_client.put('/staff/office/2/',
                                headers=staff_auth_header,
                                data=staff_office_data['normal_data_2'])
