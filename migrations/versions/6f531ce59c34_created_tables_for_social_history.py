...
def upgrade():
    ...
    sa.Column('avg_num_drinks', sa.Integer(), nullable=True),
    sa.Column('avg_num_workouts', sa.Integer(), nullable=True),
    sa.Column('job_title', sa.String(length=100), nullable=True),
    sa.Column('avg_num_meditates', sa.Integer(), nullable=True),
