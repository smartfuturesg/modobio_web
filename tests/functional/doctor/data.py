...
doctor_all_generalmedicalinfo_post_5_data = {
    "allergies": [{"allergy_symptoms": "Rash"}]
}
...
doctor_all_generalmedicalinfo_post_4_data = {
    ...
    "allergies": [{"medication_name": "medName3", "allergy_symptoms": "Rash"}],
}
...
doctor_all_socialhistory_break_post_2_data = {
    ...
    "std_history": [{"std_id": 7}, {"std_id": 25}],
}
...
doctor_all_socialhistory_post_1_data = {
    ...
    "std_history": [{"std_id": 1}, {"std_id": 2}, {"std_id": 5}],
}
...
doctor_all_generalmedicalinfo_post_1_data = {
    ...
    "allergies": [
        {"medication_name": "medName3", "allergy_symptoms": "Rash"},
        {"medication_name": "medName3", "allergy_symptoms": "Vertigo"},
        {"medication_name": "medName1", "allergy_symptoms": "Vertigo"},
    ],
}

doctor_std_delete_data = {"stds": [{"std_id": 2}]}

doctor_std_post_1_data = {"stds": [{"std_id": 1}, {"std_id": 2}]}
...
doctor_medicalmedicationsinfo_delete_data = {"delete_ids": [{"idx": 2}]}
...
doctor_medicalallergiesinfo_delete_data = {"delete_ids": [{"idx": 2}]}

doctor_medicalallergiesinfo_put_data = {
    "allergies": [{"idx": 1, "medication_name": "medName4", "allergy_symptoms": "Rash"}]
}
...
doctor_clients_external_medical_records_data = {
    "record_locators": [
        ...
        {"med_record_id": "sadfgdrg65", "institute_id": 2, "institute_name": ""},
        {"med_record_id": "sad65", "institute_id": 1, "institute_name": ""},
    ]
}
...
blood_glucose_post_data = {
    ...
    "was_fasted": True,
    "results": [
        {"modobio_test_code": "CMP001", "result_value": 69},
        {"modobio_test_code": "TST001", "result_value": 4.7},
    ],
}
...
blood_glucose_put_data = {
    ...
    "was_fasted": False,
    "results": [
        {"modobio_test_code": "CMP001", "result_value": 40},
        {"modobio_test_code": "TST001", "result_value": 8},
    ],
}
