...
('sys@modobio.com', 'Sys', 'User', true, false, true,'VFRGH3YSM4JQ', false, true, true),
('doc@modobio.com', 'Doc', 'User', true, false, true, 'KW99TSVWP884', false, true, true),
('docext@modobio.com', 'DocExt', 'User', true, false, false, 'PUR27NVP3083', false, true, false),
('physio@modobio.com', 'Physio', 'User', true, false, true, 'FG86DG4Q3J72', false, true, false),
('physioext@modobio.com', 'PhysioExt', 'User', true, false, false, 'TQ9N2M9SMQL8', false, true, true),
('nutri@modobio.com', 'Nutri', 'User', true, false, true, 'RW0QZK442FRR', false, true, false),
('nutriext@modobio.com', 'NutriExt', 'User', true, false, false, 'FPQLX97G6KGN', false, true, true),
('train@modobio.com', 'Train', 'User', true, false, true, 'QE6RS18753CH', false, true, false),
('trainext@modobio.com', 'TrainExt', 'User', true, false, false, 'FL6SB69RQWR7', false, true, true),
('pro@modobio.com', 'Pro', 'User', true, false, true, 'EXK7322KFN2G', false, true, true),
('proext@modobio.com', 'ProExt', 'User', true, false, false, 'FXF0450R7X6L', false, true, false),
('staff@modobio.com', 'Staff', 'User', true, false, true, 'BHBCBZBW4K48', false, true, false),
('cservice@modobio.com', 'ClientServices', 'User', true, false, true, 'BX4NW9897R40', false, true, true),
('name@modobio.com', 'FirstName', 'LastName', true, false, true, 'XFB1SN3GM59J', false, true, true),
('david.kubos@sde.cz', 'David', 'Kubos', true, false, true, 'EJP05FH6054T', false, true, true),
('tomas.blazek@sde.cz', 'Tomas', 'Blazek', true, false, true, 'MT5M08SCL6CQ', false, true, true),
('aneta.opletalova@sde.cz', 'Aneta', 'Opletalova', true, false, true, 'OF0K861W7J8Q', false, true, false),
('jakub.freywald@sde.cz', 'Jakub', 'Freywald', true, false, true, 'UJPH98Q8KPG6', false, true, true),
('matej.kubinec@sde.cz', 'Matej', 'Kubinec', true, false, true, 'JAF04LYTZN9W', false, true, true),
('sebastian.brostl@sde.cz', 'Sebastian', 'Brostl', true, false, true, 'VLCZG2Z2ZL5H', false, true, true),
('lukas.krajci@sde.cz', 'Lukas', 'Krajci', true, false, true, 'VS071YRSQ98Z', false, true, true),
('client@modobio.com', 'Test', 'Client', false, true, false, 'TC12JASDFF18', false, true, false);
