...
('test_remote_registration@gmail.com', 'Remote', 'Client', false, true, true,'VFRGH3YSM4JX', false, true),
('staff_member@modobio.com', 'testy', 'testerson', true, false, true, 'KW99TSVWP883', false, true);
