...
from tests.data import test_get_blood_chemistry_thyroid
...
def test_post_blood_chemistry_thyroid(test_client, init_database):
    ...
    payload = test_get_blood_chemistry_thyroid
...
def test_get_blood_chemistry_thyroid(test_client, init_database):
    """
    GIVEN a api end point for retrieving blood test - thyroid
