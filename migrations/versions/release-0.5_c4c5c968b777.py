...
def upgrade():
    ...
    op.add_column(
        "MedicalSurgeries", sa.Column("user_id", sa.Integer(), nullable=False)
    )
    op.drop_constraint(
        "MedicalSurgeries_client_user_id_fkey", "MedicalSurgeries", type_="foreignkey"
    )
    op.create_foreign_key(
        None, "MedicalSurgeries", "User", ["user_id"], ["user_id"], ondelete="CASCADE"
    )
    ...
    op.add_column(
        "Wearables",
        sa.Column(
            "registered_freestyle", sa.Boolean(), server_default="f", nullable=True
        ),
    )
    op.alter_column(
        "Wearables", "registered_freestyle", existing_type=sa.BOOLEAN(), nullable=False
    )
    op.create_unique_constraint(None, "Wearables", ["user_id"])
    op.add_column(
        "WearablesFitbit", sa.Column("wearable_id", sa.Integer(), nullable=False)
    )
    op.alter_column(
        "WearablesFitbit",
        "access_token",
    ...
    op.add_column(
        "WearablesFreeStyle", sa.Column("wearable_id", sa.Integer(), nullable=False)
    )
    ...
    op.add_column(
        "WearablesOura", sa.Column("wearable_id", sa.Integer(), nullable=False)
    )
    op.create_unique_constraint(None, "WearablesOura", ["user_id"])
    op.create_unique_constraint(None, "WearablesOura", ["wearable_id"])
    op.create_foreign_key(
        None, "WearablesOura", "Wearables", ["wearable_id"], ["idx"], ondelete="CASCADE"
    )
    op.add_column(
        "TelehealthMeetingRooms", sa.Column("booking_id", sa.Integer(), nullable=False)
    )
    op.create_foreign_key(
        None,
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            server_default=sa.text(
                "nextval('\"UserNotifications_idx_seq\"'::regclass)"
            ),
            autoincrement=True,
            nullable=False,
        ),
        ...
        sa.Column(
            "time_to_live", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        ...
        sa.ForeignKeyConstraint(
            ["notification_type_id"],
            ["LookupNotifications.notification_type_id"],
            name="UserNotifications_notification_type_id_fkey",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["User.user_id"],
            name="UserNotifications_user_id_fkey",
            ondelete="CASCADE",
        ),
    ...
    op.drop_constraint(
        "WearablesOura_wearable_id_fkey", "WearablesOura", type_="foreignkey"
    )
    ...
    op.drop_constraint(
        "WearablesFreeStyle_wearable_id_fkey", "WearablesFreeStyle", type_="foreignkey"
    )
    op.drop_constraint(
        "WearablesFreeStyle_wearable_id_key", "WearablesFreeStyle", type_="unique"
    )
    op.drop_constraint(
        "WearablesFreeStyle_user_id_key", "WearablesFreeStyle", type_="unique"
    )
    op.drop_column("WearablesFreeStyle", "wearable_id")
    op.drop_constraint(
        "WearablesFitbit_wearable_id_fkey", "WearablesFitbit", type_="foreignkey"
    )
    op.drop_constraint(
        "WearablesFitbit_wearable_id_key", "WearablesFitbit", type_="unique"
    )
    ...
    op.create_foreign_key(
        "MedicalSurgeries_client_user_id_fkey",
        "MedicalSurgeries",
        "User",
        ["client_user_id"],
        ["user_id"],
