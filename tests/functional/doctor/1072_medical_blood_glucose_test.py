...
def test_post_blood_glucose(test_client):
    ...
    glucose_test = MedicalBloodTests.query.filter_by(test_id=response.json['test_id']).one_or_none()
...
def test_delete_blood_glucose(test_client):
    ...
    glucose_test = MedicalBloodTests.query.filter_by(test_id=response_1.json["test_id"]).one_or_none()
