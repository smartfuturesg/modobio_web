...
def upgrade():
    ...
    op.create_foreign_key('telehealthbookings_paymenthistory_id_fk', 'TelehealthBookings', 'PaymentHistory', ['payment_history_id'], ['idx'])
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('telehealthbookings_paymenthistory_id_fk', 'TelehealthBookings', type_='foreignkey')
